...
export function SprintStatusModal({
  ...
  const getStatusWarning = (
    ...
    if (
      ...
      newStatus === SprintStatus.PLANNING
    ) {
  ...
  const warning = sprint
    ? getStatusWarning(sprint.status, selectedStatus)
    : null;
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Update the status of sprint: {sprint?.sprintName}
          </DialogDescription>
        </DialogHeader>
              ...
              >
                ...
                <div className="grid gap-1.5">
                  ...
                  <p className="text-sm text-muted-foreground">
                    {getStatusDescription(status as SprintStatus)}
                  </p>
                </div>
              </div>
            ))}
        ...
        <DialogFooter>
          ...
          <Button
            ...
            disabled={
              isSubmitting || (sprint && selectedStatus === sprint.status)
            }
          >
