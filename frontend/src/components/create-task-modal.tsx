            ...
            <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto">
                ...
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(handleFormSubmit)} className="space-y-4 py-4">
                                            ...
                                            <PopoverContent className="w-auto p-0" align="start" onInteractOutside={(e) => e.preventDefault()}>
                                                <Calendar
                                                    ...
                                                    onSelect={(date) => {
                                                        ...
                                                        // The user will need to click outside or press escape to close
                                                    }}
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            {/* Only display assignee selection if user is a manager, otherwise auto-assign to current user */}
                            {session?.user?.role === "MANAGER" ? (
                                ...
                                // Hidden field that sets assignedTo to current user for non-managers
                                <FormField
                                    control={form.control}
                                    name="assignedTo"
                                    render={({ field }) => {
