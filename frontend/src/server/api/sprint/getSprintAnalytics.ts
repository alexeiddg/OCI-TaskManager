import {SprintForAnalyticsSchema, SprintForAnalyticsModel} from "@/lib/types/DTO/helpers/SprintAnalyticsData";

const BASE_URL = process.env.NEXT_PUBLIC_BACKEND_URL!;

export async function fetchSprintAnalytics(teamId: number): Promise<SprintForAnalyticsModel> {
