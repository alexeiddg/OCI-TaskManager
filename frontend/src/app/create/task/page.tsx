...
export default function CreateTaskPage() {
    ...
    return (
        <div className="min-h-screen w-full flex items-center justify-center px-4 bg-cover bg-center"
            ...
            <div className="w-full max-w-4xl bg-card border rounded-lg shadow p-8">
                ...
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        {/* Priority */}
                        <FormField control={form.control} name="taskPriority" render={({ field }) => (
                            <FormItem className="col-span-1">
                        ...
                        {/* Status */}
                        <FormField control={form.control} name="taskStatus" render={({ field }) => (
                            <FormItem className="col-span-1">
